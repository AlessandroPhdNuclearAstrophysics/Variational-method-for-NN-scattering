PROGRAM FITTER_3PX_CHANNELS
  ...
  IF (COMMAND_ARGUMENT_COUNT() /= 2) THEN
    ...
    READ(MESSAGE, *) IC111    
  ELSE
    STOP "Insert min and max value for the index of C11, max is 184."
  END IF
  ENERGIES(1) = 0
  ENERGIES(2) = E
 ...
 OPEN(UNIT=200, FILE="res_3P0.dat", ACTION="WRITE", POSITION="APPEND", STATUS="UNKNOWN")
 OPEN(UNIT=201, FILE="res_3P1.dat", ACTION="WRITE", POSITION="APPEND", STATUS="UNKNOWN")
 OPEN(UNIT=202, FILE="res_3P2.dat", ACTION="WRITE", POSITION="APPEND", STATUS="UNKNOWN")
  DO IR = 1, NR
