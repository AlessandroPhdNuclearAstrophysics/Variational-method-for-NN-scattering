PROGRAM MAIN_SCATTERING_ZERO_ENERGY_R0
  ...
  TYPE(PHASE_SHIFT_RESULT) :: PS(NE,3)
  TYPE(ZERO_ENERGY_OBSERVABLES) :: ZEOBS
  TYPE(LECS_EFT_PLESS) :: LECS

  ! R_BB matrices
  DOUBLE PRECISION RBB0(NEQ_MAX,NEQ_MAX), RBB(NEQ_MAX,NEQ_MAX), K2, HTM, r0(NEQ_MAX), E
  ...
  CALL LOGGER%SET_LOG_MAX_LEVEL(0)
  ...
  ! CALL LOGGER%LOG_INFO("Energy: " // TRIM(TO_STRING(ENERGIES(1))))
