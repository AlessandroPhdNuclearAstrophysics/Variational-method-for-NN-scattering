...
PROGRAM SCATTERING_NN_VARIATIONAL_METHOD
  USE SCATTERING_NN_VARIATIONAL, ONLY: SET_VARIATIONAL_PARAMETERS, SET_ENERGIES, SET_CHANNELS, DUMP_MODULE_DATA, SET_MAX_LOG_LEVEL
  ...
  BLOCK ! MAIN LOOP
    ...
    DO ICH = 1, NCH
      ...
      DO I = 1, NE
        E =  ENERGIES(I)
        CALL NN_SCATTERING_VARIATIONAL(E, J, LMIN, S, TZ, IPOT, ILB, LEMP, PHASE_SHIFTS, PRINT_COEFFICIENTS=.FALSE., LOG_LEVEL=1)
