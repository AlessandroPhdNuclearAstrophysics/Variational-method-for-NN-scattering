...
! Calculating the phase shifts and mixing angles in the Stapp convention
  ...
  SUBROUTINE CORE_CORE_MATRIX_ELEMENTS(AM, RESET)
    ...
    NX = 100
    IF (RESET) THEN
      CALL REALLOCATE_1D_2(XPNT, PWEIGHT, NX)
      CALL REALLOCATE_2D_2(AKEM, APEM, NNN, NNN)
      CALL REALLOCATE_2D_2(HM, AXX, NNN, NNN)
      CALL GAULAG(NX, XPNT,PWEIGHT)

      CALL REALLOCATE_1D_3(XX, WG, YY, NX)
      XX = XPNT/GAMMA
      WG = PWEIGHT
      ...
      CALL REALLOCATE_2D_3(V0, V1, V2, NNL, NX)
      DO IX=1, NX
        DO I=0, NMX
      ...
      CALL REALLOCATE_3D_1(V, NX, NEQ, NEQ)
      DO I=1, NX
        R = XX(I)
  ...
  ! Prepare the potential 
    ...
    IF (RESET) THEN
      CALL REALLOCATE_3D_1(VV, NX, NCH, NCH)
      DO I = 1, NX
        RR = XX(I)
  ...
  SUBROUTINE ASYMPTOTIC_ASYMPTOTIC_MATRIX_ELEMENTS(AM, AM1, AM2, AM3, RESET)
    ...
    EPS = VAR_P%EPS
    IF (RESET) THEN
      CALL REALLOCATE_1D_3(A, B, YY, NX)
      YY(1:NX) = K*XX(1:NX)
