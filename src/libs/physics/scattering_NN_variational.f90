 ...
 20 FORMAT(" ", I5, I5, I5, I5, I5, I5)
  ...
  SUBROUTINE NN_SCATTERING_VARIATIONAL_ENERGIES_CHANNELS(ENERGIES, CHANNELS, LEMP, PHASE_SHIFTS, IPOT, ILB, LECS_FOR_PLESS, &
    ...
    IF (PRESENT(FIT_CONSTANTS) .OR. PRESENT(ORDER_OF_THE_FIT)) THEN
      ...
      ENDIF
      FITTED_ = FIT_CHANNELS_LOW_ENERGY(CHANNELS, K2, PHASE_SHIFTS, FIT_CONSTANTS_, ORDER_OF_THE_FIT_)
    ENDIF
  ...
  FUNCTION FIT_CHANNELS_LOW_ENERGY(CHANNELS_TO_FIT, ENERGIES, PHASE_SHIFTS, FIT_CONSTANTS, ORDER_OF_THE_FIT) RESULT(FITTED)
    ...
    DO ICH = 1, NCH_TO_FIT
      ...
      FITTED = FIT_CHANNEL_LOW_ENERGY(CHANNEL_TO_FIT, ENERGIES, PHASE_SHIFTS(ICH,:), FIT_CONSTANTS, ORDER_OF_THE_FIT)
    ENDDO
