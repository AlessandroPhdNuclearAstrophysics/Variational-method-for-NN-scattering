...
MODULE SCATTERING_NN_VARIATIONAL
  ...
  DOUBLE PRECISION, PARAMETER :: K_SMALL = 1.0D-5
  INTEGER :: NCH
  INTEGER :: NNN_MAX
 ...
 20 FORMAT(" ", I5, I5, I5, I5, I5, I5)
  ...
  SUBROUTINE NN_SCATTERING_VARIATIONAL_ENERGIES_CHANNELS(ENERGIES, CHANNELS, LEMP, PHASE_SHIFTS, IPOT, ILB, LECS_FOR_PLESS, &
    ...
    IF (PRESENT(FIT_CONSTANTS)) THEN
      ...
      ENDIF
      FITTED_ = FIT_CHANNELS_LOW_ENERGY(CHANNELS, K2, PHASE_SHIFTS, FIT_CONSTANTS, ORDER_OF_THE_FIT_)
    ENDIF
  ...
  FUNCTION FIT_CHANNELS_LOW_ENERGY(CHANNELS_TO_FIT, ENERGIES, PHASE_SHIFTS, FIT_CONSTANTS, ORDER_OF_THE_FIT) RESULT(FITTED)
    ...
    INTEGER :: NK2, NCH_TO_FIT, ICHFIT_CONSTANTS, NEQ_MAX, NEQ, ICH, IEQ
    LOGICAL :: FITTED
    ...
    IF (NEQ_MAX <= 0) THEN
      ...
      STOP
    ENDIF
    CALL REALLOCATE_3D_1(FIT_CONSTANTS, NCH_TO_FIT, NEQ_MAX, ORDER_OF_THE_FIT + 1)
    ...
    DO ICH = 1, NCH_TO_FIT
      ...
      DO IEQ = 1, SIZE(FIT_CONSTANTS_CHANNEL, 1)
        FIT_CONSTANTS(ICH, IEQ, :) = FIT_CONSTANTS_CHANNEL(IEQ, :)
      ENDDO
  END DO
